...
print "<form id='frmChoice' method='post' action = 'action.php' onsubmit='return validate()'>";
			...
			print "<fieldset id='group1'>";
				...
				print "<input type='checkbox' name='major[]' value='CIS-AppDev' class='major-checkbox' > CIS-AppDev <br>";
				print "<input type='checkbox' name='major[]' value='CIS-Networking' class='major-checkbox' > CIS-Networking <br>";
				print "<input type='checkbox' name='major[]' value='WDMD' class='major-checkbox' > WDMD <br>";
				print "<input type='checkbox' name='major[]' value='WD' class='major-checkbox' > WD <br>";
				print "<input type='checkbox' name='major[]' value='HTI' class='major-checkbox' > HTI <br>";
				print "<input type='checkbox' name='major[]' value='Other' class='major-checkbox' > Other <br>";
			...
			print "<fieldset id='group3'>";
				...
				print "<input type='radio' name='topping' value='Pepperoni' class='pizza-radio' > Pepperoni <br/>";
				print "<input type='radio' name='topping' value='Bacon' class='pizza-radio' > Bacon <br/>";
				print "<input type='radio' name='topping' value='Pineapple' class='pizza-radio' > Pineapple <br/>";
				print "<input type='radio' name='topping' value='Italian Sausage' class='pizza-radio' > Italian Sausage <br/>";
				print "<input type='radio' name='topping' value='Roasted Spinach' class='pizza-radio' > Roasted Spinach <br/>";			
				print "<br/>";
