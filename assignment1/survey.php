...
print "<form id='frmChoice' method='post' action = 'action.php' onsubmit='return validate()'>";
			...
			print "<fieldset id='group1'>";
				...
				print "<input type='checkbox' name='check_list[]' value='AppDev' class='major-checkbox' > CIS-AppDev <br>";
				print "<input type='checkbox' name='check_list[]' value='Networking' class='major-checkbox' > CIS-Networking <br>";
				print "<input type='checkbox' name='check_list[]' value='WDMD' class='major-checkbox' > WDMD <br>";
				print "<input type='checkbox' name='check_list[]' value='WD' class='major-checkbox' > WD <br>";
				print "<input type='checkbox' name='check_list[]' value='HTI' class='major-checkbox' > HTI <br>";
				print "<input type='checkbox' name='check_list[]' value='Other' class='major-checkbox' > Other <br>";
